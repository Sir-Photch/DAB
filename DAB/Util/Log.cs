...
namespace DAB.Util
{
    internal static class Log
    {
        ...
        internal static void Write(Level level, Exception e, string template, params object[] args)
        {
            ...
            {
                case Level.VRB:
                    Serilog.Log.Verbose(e, template, args);
                    break;
                case Level.DBG:
                    Serilog.Log.Debug(e, template, args);
                    break;
                case Level.INF:
                    Serilog.Log.Information(e, template, args);
                    break;
                case Level.WRN:
                    Serilog.Log.Warning(e, template, args);
                    break;
                case Level.ERR:
                    Serilog.Log.Error(e, template, args);
                    break;
                case Level.FTL:
                    Serilog.Log.Fatal(e, template, args);
                    break;
            }
        }
        ...
        internal static void Write(Level level, string template, params object[] args)
        {
            switch (level)
            {
                case Level.VRB:
                    ...
                    break;
                case Level.DBG:
                    Serilog.Log.Debug(template, args);
                    break;
                case Level.INF:
                    Serilog.Log.Information(template, args);
                    break;
                case Level.WRN:
                ...
                case Level.ERR:
                    ...
                    break;
                case Level.FTL:
                    Serilog.Log.Fatal(template, args);
                    break;
            }
        }
    }
