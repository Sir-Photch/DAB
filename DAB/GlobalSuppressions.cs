...
[assembly: SuppressMessage("Performance", "HAA0302:Display class allocation to capture closure", Justification = "<Ausstehend>", Scope = "member", Target = "~M:DAB.Discord.Commands.SlashCommandFactory.ApplyAllCommandsAsync(Discord.WebSocket.DiscordSocketClient)~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Performance", "HAA0301:Closure Allocation Source", Justification = "<Ausstehend>", Scope = "member", Target = "~M:DAB.Discord.Commands.SlashCommandFactory.ApplyAllCommandsAsync(Discord.WebSocket.DiscordSocketClient)~System.Threading.Tasks.Task")]
